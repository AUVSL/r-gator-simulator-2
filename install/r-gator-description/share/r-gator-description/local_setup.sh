...
: ${AMENT_CURRENT_PREFIX:="/home/samee/ros2ws/install/r-gator-description"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/r-gator-description/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/r-gator-description/environment/path.sh"
