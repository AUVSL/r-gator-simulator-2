...
: ${AMENT_CURRENT_PREFIX:="/home/samee/ros2ws/src/r-gator-simulator-2/r-gator-gazebo-tool-2/install/r-gator-gazebo-tool-2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/r-gator-gazebo-tool-2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/r-gator-gazebo-tool-2/environment/path.sh"
